...
contract VestingContract is ReentrancyGuard, Ownable {
    ...
    function createVestingSchedule(address _beneficiary, uint256 _amount, uint256 _start, uint256 _durationInDays, uint256 _cliffDurationInDays) external {
        ...
        // TODO: this check needs to be removed in favour of a check that allows schedule to be extended when it finishes (but does not apply cliff again)
        //      unless we do an explicit method for extending rather than re-using this method
